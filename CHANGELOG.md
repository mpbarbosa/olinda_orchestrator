...
- `.github/workflows/ci.yml`: baseline GitHub Actions workflow for `push` and
  `pull_request` events across Node 20 and 22.

### Changed

- CI now runs the repository's standard validation commands in GitHub Actions:
  `npm run lint`, `npm test`, and `npm run build` after `npm ci`.
- `README.md`: documents the baseline CI workflow and keeps local development
  commands aligned with CI behavior.
...
[Unreleased]: https://github.com/mpbarbosa/olinda_orchestrator/compare/v0.5.0-alpha...HEAD
[0.5.0-alpha]: https://github.com/mpbarbosa/olinda_orchestrator/compare/v0.5.0...v0.5.0-alpha
[0.5.0]: https://github.com/mpbarbosa/olinda_orchestrator/compare/v0.2.1...v0.5.0
